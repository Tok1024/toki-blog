...
export default function TOC({ toc }: { toc?: TocItem[] }) {
  ...
  return (
    ...
    <aside className="fixed hidden pl-6 lg:block xl:top-28 xl:right-8 xl:z-20 xl:col-span-1 xl:w-64">
      <nav aria-label="目录" className="max-h-[72vh] overflow-auto text-lg">
        <div className="rounded-lg border border-gray-100 bg-[#dbeafe] p-4 shadow-sm dark:border-gray-800 dark:bg-gray-900">
